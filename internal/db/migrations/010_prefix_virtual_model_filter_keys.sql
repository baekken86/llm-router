...
UPDATE virtual_models SET filter_expr = REPLACE(filter_expr, '"key":"model.intelligence"', '"key":"mc.intelligence"') WHERE filter_expr LIKE '%"key":"model.intelligence"%';
...
UPDATE virtual_models SET filter_expr = REPLACE(filter_expr, '"key":"model.hallucination"', '"key":"mc.hallucination"') WHERE filter_expr LIKE '%"key":"model.hallucination"%';
UPDATE virtual_models SET filter_expr = REPLACE(filter_expr, '"key":"coding"', '"key":"mc.coding"') WHERE filter_expr LIKE '%"key":"coding"%';
UPDATE virtual_models SET filter_expr = REPLACE(filter_expr, '"key":"model.coding"', '"key":"mc.coding"') WHERE filter_expr LIKE '%"key":"model.coding"%';
...
UPDATE virtual_models SET filter_expr = REPLACE(filter_expr, '"key":"model.cost_per_task"', '"key":"mc.cost_per_task"') WHERE filter_expr LIKE '%"key":"model.cost_per_task"%';
...
UPDATE virtual_models SET sort_expr = REPLACE(sort_expr, '"key":"model.intelligence"', '"key":"mc.intelligence"') WHERE sort_expr LIKE '%"key":"model.intelligence"%';
UPDATE virtual_models SET sort_expr = REPLACE(sort_expr, '"key":"coding"', '"key":"mc.coding"') WHERE sort_expr LIKE '%"key":"coding"%';
UPDATE virtual_models SET sort_expr = REPLACE(sort_expr, '"key":"model.coding"', '"key":"mc.coding"') WHERE sort_expr LIKE '%"key":"model.coding"%';
...
UPDATE virtual_models SET sort_expr = REPLACE(sort_expr, '"key":"model.cost_per_task"', '"key":"mc.cost_per_task"') WHERE sort_expr LIKE '%"key":"model.cost_per_task"%';
