-- +goose Up
CREATE TABLE IF NOT EXISTS global_filter_conditions (
...
CREATE TABLE IF NOT EXISTS virtual_model_filter_disabled (
...
-- +goose Down
DROP TABLE IF EXISTS virtual_model_filter_disabled;
DROP TABLE IF EXISTS global_filter_conditions;
